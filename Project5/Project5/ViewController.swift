...
//  Project5
//
//  Created by Doğukan Inci on 21.02.2022.
//
...
class ViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let leftBarButton = UIBarButtonItem(title: "Restart", style: .plain, target: self, action: #selector(restartGame))
